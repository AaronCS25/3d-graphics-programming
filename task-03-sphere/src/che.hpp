...
// Unit cube centred at the origin: 8 shared vertices, 12 triangles. Small
// enough to check the opposite array by hand, which is why the assignment asks
// for it before the sphere.
CHE make_cube(float side = 1.0f);
